...
mat_train = sio.loadmat(f'data/DATA_Htrainin_ds1.mat') #==================================
mat_val = sio.loadmat(f'data/DATA_Hvalin_ds1.mat') #==================================
x_train = mat_train['HT'].astype('float32') #==================================
x_val = mat_val['HT'].astype('float32') #==================================
